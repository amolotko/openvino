...
namespace cldnn {
    ...
    class Serializer {
    public:
        static void serialize(BufferType& buffer, const T& object) {
...
public:
    ...
    inline void process(T&& object) {
        Serializer<BufferType, T>::serialize(*buffer, object);
    }
...
template <typename T>
class Serializer<BinaryOutputBuffer, T, typename std::enable_if<std::is_arithmetic<T>::value, void>::type> {
public:
    static void serialize(BinaryOutputBuffer& buffer, const T& object) {
        buffer.write(std::addressof(object), sizeof(object));
    }
};

template <typename T>
class Serializer<BinaryInputBuffer, T, typename std::enable_if<std::is_arithmetic<T>::value, void>::type> {
public:
    static void serialize(BinaryInputBuffer& buffer, const T& object) {
